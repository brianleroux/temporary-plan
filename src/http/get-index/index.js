...
function render(session) { 
  ...
  let login = `<li><a href=https://github.com/login/oauth/authorize?redirect_url=${process.env.GITHUB_REDIRECT}&client_id=${process.env.GITHUB_CLIENT_ID}>login with github</a>`
